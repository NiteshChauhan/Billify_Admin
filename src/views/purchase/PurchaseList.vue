    ...
    <div class="card">
      ...
      <div class="header">
        <div>
          ...
          <p class="subtitle">Manage supplier purchases and payments</p>
        </div>

        <router-link to="/purchase/create" class="btn-primary">
          + New Purchase
        </router-link>
      </div>
        ...
        <table>
          ...
          <tbody>
            <tr v-for="inv in invoices" :key="inv._id">
              ...
              <td class="actions">
                <router-link :to="`/purchase/${inv._id}`" class="btn-link">
                  View
                </router-link>

                <router-link
                  :to="`/purchase/edit/${inv._id}`"
                  class="btn-link edit"
                >
                  Edit
                </router-link>
